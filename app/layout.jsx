...
export const metadata = {
  title: {
    default: 'Karan Singh Rathore - Freelance AI/ML Engineer or Developer',
  ...
  openGraph: {
    ...
    title: 'Karan Singh Rathore - Freelance AI/ML Engineer or Developer',
    description: 'Passionate AI/ML developer with expertise in OpenSource LLMs and Deep Learning Models. I create scalable, applications that solve real-world problems.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Karan Singh Rathore - Freelance AI/ML Engineer orDeveloper',
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "jobTitle": "Freelance AI/ML Engineer or Developer",
              "description": "Passionate AI/ML developer with expertise in OpenSource LLMs and Deep Learning Models. I create scalable, applications that solve real-world problems.",
